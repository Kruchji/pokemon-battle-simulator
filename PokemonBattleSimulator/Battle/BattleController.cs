        ...
        while (true)
        {
            ...
            switch (userInput)
            {
                ...
                case "battlemany":
                    ...
                    int? battleCount = Prompts.PromptUntilValid("Enter the number of battles to simulate:", Parsers.TryParseIntInRange(1, _maxNumberOfBattles), "Please enter a valid number between 1 and 100000.");
                ...
                case "battleteammany":
                    ...
                    int? teamBattleCount = Prompts.PromptUntilValid("Enter the number of battles to simulate:", Parsers.TryParseIntInRange(1, _maxNumberOfBattles), "Please enter a valid number between 1 and 100000.");
